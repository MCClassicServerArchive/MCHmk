...
namespace MCHmk.Commands {
    public class CmdBotSummon : Command {
        ...
        public CmdBotSummon(Server s) : base(s) { }
        ...
        public override void Use(Player p, string args) {
            ...
            if (who == null) {
                p.SendMessage("There is no bot " + args + "!");
                return;
            }
        ...
        /// <summary>
        /// Called when /help is used on /botsummon.
        /// </summary>
        /// <param name="p"> The player that used the /help command. </param>
        public override void Help(Player p) {
            p.SendMessage("/botsummon <name?> - Summons a bot to your current position.");
        }
    }
}
