...
namespace MCHmk.Commands {
    public class CmdSpawn : Command {
        private ReadOnlyCollection<string> _keywords = Array.AsReadOnly<string>(
            new string[] {"level", "lvl", "map", "player", "user"});
        ...
        public CmdSpawn(Server s) : base(s) { }
        ...
        /// <summary>
        /// Called when /help is used on /spawn.
        /// </summary>
        /// <param name="p"> The player that used the /help command. </param>
        public override void Help(Player p) {
            p.SendMessage("/spawn - Teleports yourself to the spawn location in the current map.");
        }
    }
}
